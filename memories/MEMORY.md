...
§
P值/R值系统（2026-06-06三轮讨论定稿）：①单一贝叶斯后验P值 ②R=P/(1-P)×PE修正，PE修正=0.5/PE_percentile（无自由参数）③价格反馈：涨超1.5σ→+2pp，跌超1.5σ→-3pp ④A3反馈双条件：p<0.05 AND ρ<-0.5→🔴必须分析 ⑤系统全图景是给AI看的全局导航图
§
